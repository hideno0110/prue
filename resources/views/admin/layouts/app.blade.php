...
<head>
    ...
    <!--google maps--> 
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDY3plks7RAekRdZ70FWj-TkHEM6qttg4w"></script>
    <!-- Scripts -->
    <script>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/admin/inventories">Lists</a></li>
            <li><a href="/admin/inventories/create">Creat</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/admin/shops">ShopBranchLists</a></li>
            <li><a href="/admin/shop_lists">Shops</a></li>
          </ul>
        </li>
        <li><a href="/admin/mws/fba-inv">FBA</a></li>
        <li><a href="/admin/mws/sell">Sales</a></li>
